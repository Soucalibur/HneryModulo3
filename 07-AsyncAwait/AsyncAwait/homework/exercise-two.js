...
async function problemA () {
  ...
  await Promise.all([blue(await promisifiedReadFile('poem-two/stanza-01.txt')),blue(await promisifiedReadFile('poem-two/stanza-02.txt'))])
  console.log("done")
...
async function problemB () {
  ...
  // AsyncAwait version
    ...
    //   await blue(promisifiedReadFile(i))
    // }
    // console.log("done")

    const array = filenames.map((file)=> asincronico(file))
